...
namespace ShopAI.Models
{
    ...
    public class Order
    {
        ...
        [Range(0.00, 100000.00, ErrorMessage = "Total Base Amount must be between Rs. 0.00 and Rs. 100,000.00.")]
        public decimal TotalBaseAmount { get; set; }

        [Required]
        [Column(TypeName = "decimal(18,2)")]
        [Range(0.00, 100000.00, ErrorMessage = "Total Discount Amount must be between Rs. 0.00 and Rs. 100,000.00.")]
        public decimal TotalDiscountAmount { get; set; }

        [Column(TypeName = "decimal(18,2)")]
        [Range(0.00, 10000.00, ErrorMessage = "Shipping Cost must be between Rs. 0.00 and Rs. 10,000.00.")]
        public decimal ShippingCost { get; set; }

        [Required]
        [Column(TypeName = "decimal(18,2)")]
        [Range(0.00, 110000.00, ErrorMessage = "Total Amount must be between Rs. 0.00 and Rs. 110,000.00.")]
