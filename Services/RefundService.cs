                        ...
                        <div style='padding: 20px;'>
                            ...
                            <table style='width: 100%; border-collapse: collapse;'>
                                ...
                                <tr>
                                    ...
                                    <td style='border: 1px solid #ddd; padding: 8px;'>Rs.{cancellation.OrderAmount}</td>
                                </tr>
                                <tr>
                                    <td style='border: 1px solid #ddd; padding: 8px;'>Cancellation Charges</td>
                                    <td style='border: 1px solid #ddd; padding: 8px;'>Rs.{cancellation.CancellationCharges ?? 0.00m}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style='border: 1px solid #ddd; padding: 8px;'>Rs.{refund.Amount}</td>
                                </tr>
                                <tr>
