                ...
                <div style='max-width: 700px; margin: auto; background-color: #ffffff; padding: 20px; border: 1px solid #dddddd;'>
                  ...
                  <table style='width: 100%; border-collapse: collapse; margin-bottom: 20px;'>
                    ...
                    <tr>
                      ...
                      <td style='padding: 8px; border: 1px solid #dddddd;'>Rs. {item.UnitPrice}</td>
                      <td style='padding: 8px; border: 1px solid #dddddd;'>Rs. {item.Discount}</td>
                      <td style='padding: 8px; border: 1px solid #dddddd;'>Rs. {item.TotalPrice}</td>
                    </tr>
                    "))}
                  </table>
                  ...
                  <p>Best regards,<br/>ShopAI Team</p>
                </div>
              </body>
            </html>";
